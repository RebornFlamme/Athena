 ...
 */
export function PanneauDiff({ ligne, onFermer }: { ligne: LigneSemantic; onFermer: () => void }) {
  return (
    <aside className="flex h-full flex-col bg-card">
      <EnTetePanneau icon={GitCompareArrows} titre={`Diff — ${ligne.objet}`} onFermer={onFermer} />
